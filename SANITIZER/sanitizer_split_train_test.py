...
ap.add_argument('-tf, --tensorflow-enabled', type=int, required=False, default=-1, help='enter number >1 if want to copy train/test to seperate directory with "loose image and annotation files"')
